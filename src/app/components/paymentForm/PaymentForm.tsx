    ...
    <div className="w-full bg-white">
      ...
      {userInfo ? (
        <Button
          ...
          className="bg-darkText rounded-lg text-slate-100 mt-4 py-3 px-6 hover:bg-[#1e1e1e] cursor-pointer duration-300"
        >
          Proceed to checkout
        </Button>
      ) : (
        <div>
          <Button className="bg-darkText rounded-lg text-slate-100 mt-4 py-3 px-6 cursor-not-allowed">
            Proceed to checkout
          </Button>
